...
@Bot.on_message((filters.document | filters.video | filters.audio | filters.photo | filters.sticker | filters.emoji | filters.gif | filters.message) & ~filters.chat(Config.DB_CHANNEL))
